...
- MELHORIA: Insere etapa de cancelamento de classificação após pontos de entrada
- MELHORIA: Criado job PTXJ009 exclusivo para baixar XML do e-mail
- MELHORIA: Adiciona opção de exportar XML de NFSe
- BUG: Adiciona nome fixo ao relatório para evitar bug de layout
- BUG: corrige bug de legenda NFS e realiza validação de série
